...
def train_models():
    ...
    rf_r=RandomForestRegressor(100,random_state=42).fit(Xr,final)
    gb_r=GradientBoostingRegressor(100,random_state=42).fit(Xr,final)
    ...
    rf_c=RandomForestClassifier(100,random_state=42).fit(Xc,lbl)
    gb_c=GradientBoostingClassifier(100,random_state=42).fit(Xc,lbl)
